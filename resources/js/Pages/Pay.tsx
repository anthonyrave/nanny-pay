        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg text-gray-900">
            ...
            <div className="px-6 py-2 mb-6">
              ...
              <div className="mb-2">
                <Label htmlFor="hours-rate">
                  Salaire horaire de base (en euros)
                </Label>
                <Input
                  className="w-80"
              ...
              <div className="mb-2">
                <Label htmlFor="increase-rate">
                  Taux de majorations des heures au delà de {increasedRateAbove}
                  h
                </Label>
                <Input
                  className="w-80"
                ...
                <div>
                  ...
                  <div className="mb-2">
                    ...
                    <Input
                      ...
                      id="free-days"
                      value={Math.max(
                        baseWorkingDaysCount - selectedDates.length,
                        0,
                      )}
                      type="text"
                      disabled
            ...
            <div className="px-6 py-2 mb-6">
              ...
              <div className="mb-2">
                ...
                <Input
                  ...
                  value={
                    Math.round(
                      (getBaseNetSalary() + getIncreasedSalary()) * 100,
                    ) / 100
                  }
                  type="text"
                  disabled
